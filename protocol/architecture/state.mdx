...
| `redeem(shares, receiver, controller)` | Write | Hub | Claim across the controller's matured requests in storage order. |
| `withdraw(assets, receiver, controller)` | Write | Hub | Claim a target asset amount across the controller's matured requests in storage order. |
